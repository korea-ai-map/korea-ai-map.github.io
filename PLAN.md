...
> **현황 (2026-08)**: Phase 0~2 완료. 데이터 규모는 조직 142·모델 169·제품 77·오픈소스 53·데이터셋 119·벤치마크 22·논문 244 = **826건**으로 MVP 목표(100+)를 크게 상회. GitHub Pages 배포 운영 중.
...
- [x] `data/` 데이터 입력 (목표 대비 대폭 초과, 현재 826건)
