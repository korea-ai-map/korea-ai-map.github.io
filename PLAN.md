...
> **현황 (2026-09)**: Phase 0~2 완료. 데이터 규모는 조직 147·모델 178·제품 78·오픈소스 61·데이터셋 127·벤치마크 28·논문 281 = **900건**으로 MVP 목표(100+)를 크게 상회. GitHub Pages 배포 운영 중.
...
- [x] `data/` 데이터 입력 (목표 대비 대폭 초과, 현재 900건)
